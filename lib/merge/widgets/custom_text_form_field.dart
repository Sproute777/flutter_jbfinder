...
extension TextFormFieldStyleHelper on CustomTextFormField {
  static OutlineInputBorder get fillBluegray1006c => OutlineInputBorder(
        borderRadius: BorderRadius.circular(
          getHorizontalSize(
            8.00,
          ),
  ...
  static OutlineInputBorder get outlineIndigo2002d => OutlineInputBorder(
        borderRadius: BorderRadius.circular(
          getHorizontalSize(
            20.00,
          ),
  ...
  static OutlineInputBorder get fillOnPrimaryContainerTL6 => OutlineInputBorder(
        borderRadius: BorderRadius.circular(
          getHorizontalSize(
            6.00,
          ),
  ...
  static OutlineInputBorder get fillOnPrimaryContainerTL61 =>
      OutlineInputBorder(
        borderRadius: BorderRadius.circular(
          getHorizontalSize(
            6.00,
